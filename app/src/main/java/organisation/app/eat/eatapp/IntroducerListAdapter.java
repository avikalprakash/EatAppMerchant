...
public class IntroducerListAdapter extends BaseAdapter{
    ...
    ArrayList<IntroducerPojo> introducerPojoArrayList =new  ArrayList<>();
    Context context;
    LayoutInflater layoutInflater;
    ImageView imageView;
    TextView introducer_name, phone_no, user_name, date;



    public IntroducerListAdapter(FragmentActivity activity, ArrayList<IntroducerPojo> introducerPojoArrayList){
    ...
    public View getView(int i, View view, ViewGroup viewGroup) {
         ...
         view = layoutInflater.inflate(R.layout.intro_adapter_layout, null);
        ...
        introducer_name.setText(introducerPojoArrayList.get(i).getIntroducer_name());
        phone_no.setText(introducerPojoArrayList.get(i).getIntroducer_phone());
