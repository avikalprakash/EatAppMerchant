...
public class PaidItemQrScannerHandler extends AppCompatActivity implements ZXingScannerView.ResultHandler {
    ...
    public void handleResult(Result rawResult) {
        ...
        String key="keyPaid";
        Intent i=new Intent(PaidItemQrScannerHandler.this,MainActivity.class);
        i.putExtra("key", key);
