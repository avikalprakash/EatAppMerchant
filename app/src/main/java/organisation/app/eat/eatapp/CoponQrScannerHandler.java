...
public class CoponQrScannerHandler extends AppCompatActivity implements ZXingScannerView.ResultHandler {
    ...
    public void handleResult(Result rawResult) {
        ...
        String key="key";
        Intent i=new Intent(CoponQrScannerHandler.this,MainActivity.class);
        i.putExtra("key", key);
