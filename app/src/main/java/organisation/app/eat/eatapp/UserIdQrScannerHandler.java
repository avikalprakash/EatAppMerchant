...
public class UserIdQrScannerHandler extends AppCompatActivity implements ZXingScannerView.ResultHandler {
...
//                handler.ZINGSCANNERVIEW=1;
    ...
    public void handleResult(Result rawResult) {
        ...
        Data = rawResult.getText();
                ...
                String key="keyIntroducer";
                Intent i=new Intent(UserIdQrScannerHandler.this,MainActivity.class);
                i.putExtra("key", key);
